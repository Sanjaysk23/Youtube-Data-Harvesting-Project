...
with st.sidebar:
    selected = option_menu(None, ["Home","Extract & Transform","View"], 
                           ...
                           styles={"nav-link": {"font-size": "30px", "text-align": "centre", "margin": "0px", 
                                   ...
                                   "nav-link-selected": {"background-color": "#bf1e06"}})
...
def Api_connect():
    Api_Id = 'AIzaSyDlunNd7iZcpWD_j7lEHBFuJUeluaT13E4'
...
if selected == "Home":
    ...
    col1.markdown("## :red[Technologies used] : Python,MongoDB, Youtube Data API, MySql, Streamlit")
    col1.markdown("## :red[Overview] : Retrieving the Youtube channels data from the Google API, storing it in a MongoDB as data lake, migrating and transforming data into a SQL database,then querying the data and displaying it in the Streamlit app.")
    col2.markdown("#   ")
    col2.markdown("#   ")
    col2.markdown("#   ")
